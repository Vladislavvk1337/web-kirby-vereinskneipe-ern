...
/**
 * Regeln des Freigabeworkflows – ohne Kirby-Abhängigkeit, damit sie
 * direkt getestet werden können. Die Hooks in hooks.php setzen sie durch.
 *
...
final class Workflow
{
	...
	/**
	 * Darf die Rolle den Kirby-Veröffentlichungsstatus eines Termins ändern?
	 */
